    ...
    <div className="pt-32 pb-24 bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 shadow-sm rounded-full mb-6">
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-slate-50 border border-slate-200 rounded-3xl p-10"
        >

          <div className="grid grid-cols-2 md:grid-cols-4 gap-10">

            {[
              { label: "Fixed Costing", icon: <ShieldCheck size={26} /> },
              { label: "Infinite AI Upgrades", icon: <Zap size={26} /> },
              { label: "System Optimization", icon: <Orbit size={26} /> },
              { label: "Active Partnership", icon: <Activity size={26} /> },
            ].map((item, i) => (

              <div key={i} className="flex flex-col items-center text-center">

                <div className="w-14 h-14 bg-white border border-slate-200 rounded-xl flex items-center justify-center mb-4 text-slate-700">
                  {item.icon}
                </div>
